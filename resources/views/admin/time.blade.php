<x-layout>
    ...
    <div class="metrics-top-grid">
        <div class="metric-card glass-card">
            ...
            <h3 class="metric-value">@real($teamPerformance->sum('total_revenue'))</h3>
            <div class="metric-footer">
                ...
                <div class="metric-sparkline">
                    <svg width="100" height="30" viewBox="0 0 100 30" class="sparkline-placeholder">
                        <path d="M0 25 L20 15 L40 20 L60 10 L80 18 L100 5" fill="none" stroke="#4CAF50"
                            stroke-width="2" />
                    </svg>
                </div>
            </div>
        ...
        <div class="metric-card glass-card">
            ...
            <h3 class="metric-value">@real($teamPerformance->sum('total_cost'))</h3>
            <div class="metric-footer">
                <span class="metric-change negative">-5,1%</span>
                <span class="metric-period">Na última semana</span>
                <div class="metric-sparkline">
                    <svg width="100" height="30" viewBox="0 0 100 30" class="sparkline-placeholder">
                        <path d="M0 5 L20 15 L40 10 L60 20 L80 15 L100 25" fill="none" stroke="#ff4d4d"
                            stroke-width="2" />
                    </svg>
                </div>
            </div>
        ...
        <div class="metric-card glass-card">
            ...
            <h3 class="metric-value">@real($teamPerformance->sum('total_profit'))</h3>
            <div class="metric-footer">
                <span class="metric-change positive">18,5%</span>
                <span class="metric-period">Na última semana</span>
                <div class="metric-sparkline">
                    <svg width="100" height="30" viewBox="0 0 100 30" class="sparkline-placeholder">
                        <path d="M0 10 L20 20 L40 15 L60 25 L80 12 L100 5" fill="none" stroke="#4CAF50"
                            stroke-width="2" />
                    </svg>
                </div>
            </div>
        ...
        <div class="metric-card glass-card">
            ...
            <h3 class="metric-value">{{ number_format($teamPerformance->avg('total_roi') * 100, 2, ',', '.') }}%</h3>
            <div class="metric-footer">
                <span class="metric-change positive">10,1%</span>
                <span class="metric-period">Na última semana</span>
                <div class="metric-sparkline">
                    <svg width="100" height="30" viewBox="0 0 100 30" class="sparkline-placeholder">
                        <path d="M0 10 L20 15 L40 8 L60 20 L80 15 L100 25" fill="none" stroke="#4CAF50"
                            stroke-width="2" />
                    </svg>
                </div>
            </div>
                    ...
                    <div class="chart-time-container">
                        ...
                        <div class="chart-area-time">
                            <svg width="100%" height="150" viewBox="0 0 100 100" preserveAspectRatio="none">
                                <path d="M0 80 L10 70 L20 60 L30 40 L40 50 L50 30 L60 20 L70 10 L80 30 L90 20 L100 40"
                                    fill="none" stroke="#2196F3" stroke-width="2.5" class="chart-line" />
                            </svg>
                        </div>
                        ...
                        @foreach ($users as $user)
                            <tr>
                                <td class="col-main-data">
                                    ...
                                    <span class="member-email">{{ substr($user->email,0,10)}}</span>
                                </td>
                                <td>{{ $user->roles->first() !== null ? $user->roles->first()->title: '' }}</td>
                                <td>14/06/25</td>
            ...
            <div class="chart-projects-container">
                ...
                <div class="chart-area-projects">
                    <svg width="100%" height="200" viewBox="0 0 100 100" preserveAspectRatio="none">
                        <path d="M0 80 L10 65 L20 40 L30 50 L40 35 L50 20 L60 30 L70 10 L80 15 L90 5 L100 10"
                            fill="none" stroke="#64B5F6" stroke-width="3" class="chart-line chart-line-active"
                            data-points="10,25,40,30,45,60,50,70,65,75,70" />
                        <path d="M0 90 L10 75 L20 60 L30 55 L40 45 L50 35 L60 40 L70 30 L80 45 L90 40 L100 50"
                            fill="none" stroke="#2196F3" stroke-width="3" class="chart-line chart-line-paused"
                            data-points="5,15,30,35,45,55,50,60,45,50,40" />
                        <path d="M0 95 L10 85 L20 80 L30 75 L40 70 L50 65 L60 60 L70 55 L80 50 L90 45 L100 40"
                            fill="none" stroke="#FF5722" stroke-width="3" class="chart-line chart-line-zeroed"
                            data-points="2,5,10,15,20,25,30,35,40,45,50" />
                    </svg>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            bars.forEach(bar => {
                bar.addEventListener('mouseenter', (e) => {
                    ...
                    const containerRect = document.querySelector('.top-nichos-card')
                        .getBoundingClientRect();

                    // mostrar o tooltip em cima
                    tooltip.style.left = `${e.clientX - containerRect.left}px`;
                    tooltip.style.top =
                        `${e.clientY - containerRect.top - 10}px`; // -10px para flutuar acima
                });
