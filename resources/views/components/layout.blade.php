...
<head>
    ...
    @vite([
        ...
        'resources/css/css-admin/admin-copy-dashboard.css',
        'resources/css/css-admin/admin-creatives.css',
        'resources/css/css-admin/admin-cadastro.css',
        'resources/css/css-admin/admin-listagem.css',
        'resources/js/app.js',
    ])
    @stack('styles')
</head>
    ...
    <div class="admin-page-wrapper">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    @php
                        $isCopywriterIN  = request()->routeIs('admin.agents') && request()->route('type') === 'copywriters' && request()->route('collaborator') === 'IN';
                        $isCopywriterEX  = request()->routeIs('admin.agents') && request()->route('type') === 'copywriters' && request()->route('collaborator') === 'EX';
                        $isEditorIN      = request()->routeIs('admin.agents') && request()->route('type') === 'editors'      && request()->route('collaborator') === 'IN';
                        $isCreativeIN    = request()->routeIs('admin.creatives') && request()->route('collaborator') === 'IN';
                        $isCreativeEX    = request()->routeIs('admin.creatives') && request()->route('collaborator') === 'EX';
                        $isMetricas      = $isCopywriterIN || $isCopywriterEX || $isEditorIN || $isCreativeIN || $isCreativeEX || request()->routeIs('colaboradores.metas');
                    @endphp
                    ...
                    <li class="nav-item has-submenu {{ request()->routeIs('admin.time', 'admin.faturamento', 'admin.gestores') ? 'active' : '' }}">
                        <a href="#" class="nav-link submenu-toggle">
                            <i class="fas fa-database nav-icon"></i> Dados
                            <i class="fas fa-chevron-down submenu-arrow"></i>
                        </a>

                        <ul class="submenu {{ request()->routeIs('admin.time', 'admin.faturamento', 'admin.gestores') ? 'show' : '' }}">
                            <li>
                                <a href="{{ route('admin.time') }}" class="nav-link submenu-link {{ request()->routeIs('admin.time') ? 'active' : '' }}">
                                    <i class="fas fa-users nav-icon"></i> Time
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.faturamento') }}" class="nav-link submenu-link {{ request()->routeIs('admin.faturamento') ? 'active' : '' }}">
                                    <i class="fas fa-wallet nav-icon"></i> Faturamento
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.gestores') }}" class="nav-link submenu-link {{ request()->routeIs('admin.gestores') ? 'active' : '' }}">
                    ...
                    <li class="nav-item has-submenu {{ $isMetricas ? 'active' : '' }}">
                        ...
                        <ul class="submenu {{ $isMetricas ? 'show' : '' }}">
                            <li>
                                <a href="{{ route('colaboradores.metas') }}" class="nav-link submenu-link {{ request()->routeIs('colaboradores.metas') ? 'active' : '' }}">
                                    <i class="fas fa-bullseye nav-icon"></i> Metas
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.agents', ['copywriters', 'IN']) }}" class="nav-link submenu-link {{ $isCopywriterIN ? 'active' : '' }}">
                                    <i class="fas fa-pen-fancy nav-icon"></i> Copywriters Internos
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.agents', ['copywriters', 'EX']) }}" class="nav-link submenu-link {{ $isCopywriterEX ? 'active' : '' }}">
                                    <i class="fas fa-edit nav-icon"></i> Copywriters Externos
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.agents', ['editors', 'IN']) }}" class="nav-link submenu-link {{ $isEditorIN ? 'active' : '' }}">
                                    <i class="fas fa-video nav-icon"></i> Editores Internos
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.creatives', 'IN') }}" class="nav-link submenu-link {{ $isCreativeIN ? 'active' : '' }}">
                                    <i class="fas fa-layer-group nav-icon"></i> Criativos Internos
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.creatives', 'EX') }}" class="nav-link submenu-link {{ $isCreativeEX ? 'active' : '' }}">
                    ...
                    <li class="nav-item has-submenu {{ request()->routeIs('admin.users.create') ? 'active' : '' }}">
                        <a href="#" class="nav-link submenu-toggle">
                        ...
                        <ul class="submenu {{ request()->routeIs('admin.users.create') ? 'show' : '' }}">
                            <li>
                                <a href="{{ route('admin.users.create') }}" class="nav-link submenu-link {{ request()->routeIs('admin.users.create') ? 'active' : '' }}">
                    ...
                    <li class="nav-item has-submenu {{ request()->routeIs('tarefas.listagem', 'tarefas.cadastro') ? 'active' : '' }}">
                        <a href="#" class="nav-link submenu-toggle">
                            <i class="fa fa-bars nav-icon"></i> Tarefas
                            <i class="fas fa-chevron-down submenu-arrow"></i>
                        </a>

                        <ul class="submenu {{ request()->routeIs('tarefas.listagem', 'tarefas.cadastro') ? 'show' : '' }}">
                            <li>
                                <a href="{{ route('tarefas.listagem') }}" class="nav-link submenu-link {{ request()->routeIs('tarefas.listagem') ? 'active' : '' }}">
                                    <i class="fa-solid fa-list nav-icon"></i> Listagem
                                </a>
                            </li>
                            @if(auth()->user()->hasAnyRole(['ADMIN', 'HEAD', 'MANAGER', 'GESTOR']))
                            <li>
                                <a href="{{ route('tarefas.cadastro') }}" class="nav-link submenu-link {{ request()->routeIs('tarefas.cadastro') ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ request()->routeIs('admin.import.index') ? 'active' : '' }}">
